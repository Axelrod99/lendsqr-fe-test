...
const GeneralDetails = () => {
  return (
    <div className="bg-white p-[30px] shadow-[#0000001c] shadow">
      <div className="flex flex-col gap-2 pb-[30px]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-6">
          ...
          <div className="flex flex-col gap-2 py-5">
            ...
            <p className="text-[#545F7D] font-semibold text-[12px] sm:text-[16px]">grace@gmail.com</p>
          </div>
          <div className="flex flex-col gap-2 py-5">
      ...
      <div className="flex flex-col gap-2 py-[30px] border-t">
        <p className="font-semibold text-[16px] text-[#213F7D]">Socials</p>
      ...
      <div className="flex flex-col gap-2 py-[30px] border-t">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="flex flex-col gap-2 py-5">
            <p className="text-[#545F7D] text-[12px]">EMAIL ADDRESS</p>
            <p className="text-[#545F7D] font-semibold text-[12px] sm:text-[16px]">debby@gmail.com</p>
          </div>
          <div className="flex flex-col gap-2 py-5">
